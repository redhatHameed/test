...
export APP_REGISTRY=ahameed;export APP_REGISTRY_ORG=ahameed;export INTERNAL_REGISTRY="lb-mw-ocp4-cl2.cloud.lab.eng.bos.redhat.com:5000/images"
...
--auth-token="basic YWhhbWVlZDpIYW1lZWRAMTIz"
...
**Step 4: DisableA ll DefaultSources , this step required only onece**
